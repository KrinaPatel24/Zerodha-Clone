...
function Footer() {
  return (
    <div className=" mt-5 border-top " style={{backgroundColor: "#fbfbfb", color: "#424242"}}>
      <div className="row mt-5 footer">
        <div className="col">
          <img src="media/images/logo.svg" alt="logo" className="w-50" />
          <div>
            &copy; 2010 - 2024, Not Zerodha <br /> Broking  Ltd.
        ...
        <div className="col footer-links">
          ...
          <br />
          <a href="">6o day challenge</a>
          <br />
        </div>
      </div>
      <div className="  text-muted mt-0" style={{marginLeft: "10rem", marginRight: "10rem", fontSize:"14px", marginTop: "0 !"}}>
